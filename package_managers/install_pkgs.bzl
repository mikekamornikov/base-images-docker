...
ls -la /tmp/tmp_installer_ai_75.sh

docker run -v $(pwd)/{installables_tar}:/tmp/{installables_tar} -v /tmp/tmp_installer_ai_75.sh:/tmp/installer.sh --privileged $image_id ls -la /tmp
exit 1
